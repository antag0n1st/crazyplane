...
function FrontLayer() {
    ...
    var ground_bounds_1 = new Polygon(new Vector(), [
        new Vector(0, 20),
        new Vector(800, 20),
        new Vector(800, 100),
        new Vector(0, 100)
    ...
    var ground_bounds_2 = new Polygon(new Vector(), [
        new Vector(0, 20),
        new Vector(800, 20),
        new Vector(800, 100),
        new Vector(0, 100)
    ...
    var ground_bounds_3 = new Polygon(new Vector(), [
        new Vector(0, 20),
        new Vector(800, 20),
        new Vector(800, 100),
        new Vector(0, 100)
    ...
    var ground_bounds_4 = new Polygon(new Vector(), [
        new Vector(0, 20),
        new Vector(800, 20),
        new Vector(800, 100),
        new Vector(0, 100)
    ...
    this.ground1.bounds = ground_bounds_1;
    this.ground2.bounds = ground_bounds_2;
    this.ground3.bounds = ground_bounds_3;
    this.ground4.bounds = ground_bounds_4;
